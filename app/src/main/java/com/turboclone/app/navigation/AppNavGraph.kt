...
import com.turboclone.app.ui.screens.driver.AdminDriversScreen
import com.turboclone.app.ui.screens.driver.DriverApplicationScreen
    ...
    NavHost(navController = navController, startDestination = Routes.SPLASH) {
        ...
        composable(Routes.PROFILE) {
            ProfileScreen(
                ...
                onOpenDriverApplication = { navController.navigate(Routes.DRIVER_APPLICATION) },
                onOpenAdmin = { navController.navigate(Routes.ADMIN_DRIVERS) }
            )
        }

        composable(Routes.DRIVER_APPLICATION) {
        ...
        composable(Routes.ADMIN_DRIVERS) {
            AdminDriversScreen(onBack = { navController.popBackStack() })
        }
    }
}
